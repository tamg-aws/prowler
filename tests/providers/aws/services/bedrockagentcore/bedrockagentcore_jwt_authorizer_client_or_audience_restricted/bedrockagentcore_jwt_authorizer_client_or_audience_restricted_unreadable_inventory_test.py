...
CHECK_NAME = "bedrockagentcore_jwt_authorizer_client_or_audience_restricted"
STORES = [
    ("agent_runtimes_scan_errors", "runtime/unknown"),
    ("gateways_scan_errors", "gateway/unknown"),
]
...
class Test_bedrockagentcore_jwt_authorizer_client_or_audience_restricted_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_jwt_authorizer_client_or_audience_restricted."""
