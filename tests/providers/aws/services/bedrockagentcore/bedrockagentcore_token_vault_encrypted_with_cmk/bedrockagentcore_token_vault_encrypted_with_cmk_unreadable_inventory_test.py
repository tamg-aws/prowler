...
CHECK_NAME = "bedrockagentcore_token_vault_encrypted_with_cmk"
STORES = [("token_vaults_scan_errors", "token-vault/unknown")]
...
class Test_bedrockagentcore_token_vault_encrypted_with_cmk_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_token_vault_encrypted_with_cmk."""
