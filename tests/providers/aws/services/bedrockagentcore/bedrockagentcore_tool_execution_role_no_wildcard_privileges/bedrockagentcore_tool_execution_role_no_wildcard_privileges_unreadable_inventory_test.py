...
CHECK_NAME = "bedrockagentcore_tool_execution_role_no_wildcard_privileges"
STORES = [
    ("browsers_scan_errors", "browser/unknown"),
    ("code_interpreters_scan_errors", "code-interpreter/unknown"),
]
...
class _StubClient:
    ...
    def __init__(self, errors):
        """Initialize a stub client with scan errors for each AgentCore resource type."""
...
class Test_bedrockagentcore_tool_execution_role_no_wildcard_privileges_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_tool_execution_role_no_wildcard_privileges."""
