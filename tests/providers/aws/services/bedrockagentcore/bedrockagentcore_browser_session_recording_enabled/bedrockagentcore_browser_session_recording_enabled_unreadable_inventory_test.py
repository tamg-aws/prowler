...
CHECK_NAME = "bedrockagentcore_browser_session_recording_enabled"
STORES = [("browsers_scan_errors", "browser/unknown")]
...
class Test_bedrockagentcore_browser_session_recording_enabled_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_browser_session_recording_enabled."""
