...
CHECK_NAME = "bedrockagentcore_memory_encrypted_with_cmk"
STORES = [("memories_scan_errors", "memory/unknown")]
...
class Test_bedrockagentcore_memory_encrypted_with_cmk_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_memory_encrypted_with_cmk."""
