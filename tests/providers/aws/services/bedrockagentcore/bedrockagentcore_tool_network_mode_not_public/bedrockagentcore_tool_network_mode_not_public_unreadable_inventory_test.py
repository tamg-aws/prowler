...
CHECK_NAME = "bedrockagentcore_tool_network_mode_not_public"
STORES = [
...
class Test_bedrockagentcore_tool_network_mode_not_public_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_tool_network_mode_not_public."""
