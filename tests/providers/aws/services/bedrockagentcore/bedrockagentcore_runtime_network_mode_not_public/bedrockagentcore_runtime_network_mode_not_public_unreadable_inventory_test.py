...
CHECK_NAME = "bedrockagentcore_runtime_network_mode_not_public"
...
class Test_bedrockagentcore_runtime_network_mode_not_public_unreadable_inventory:
    """Tests for the region-level MANUAL findings of bedrockagentcore_runtime_network_mode_not_public."""
